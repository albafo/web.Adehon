                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" id="formDemandante" method="post">
                        ...
                        <div class="row form-group text-center">
                            <button id="btnAdd" class="btn btn-success">Añadir docente</button>
                        </div>
    ...
    <script>
        ...
        function rellenar_form(usuario) {
            $.each(usuario, function(index, value){
                ...
                $("select[name='usuario["+index+"]']").val(value);
        ...
        $(function(){
            ...
            $('body').on('blur', "#field_dni", function(){
                var dni = $(this).val();
                if(dni!="")
                    $.get('{{url('docente/consulta-dni')}}', {"dni":dni}, function(result){

                        $('input[name="tipoUsuario"]').val(result.tipo_usuario);
                        if(result.tipo_usuario == "no-docente") {
                            $('input[name="usuarioId"]').val(result.usuario.id);
                            rellenar_form(result.usuario);
                        }

                        if(result.tipo_usuario == "docente")
                            window.location.href = "{{url('docente/ficha-docente')}}/"+result.usuario.id;
