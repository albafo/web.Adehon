 ...
 * @method static \Illuminate\Database\Query\Builder|\TrabajoUsuario whereUsuarioId($value)
 ...
 */
class TrabajoUsuario extends Eloquent {
	protected $table = 'trabajos_usuarios';
