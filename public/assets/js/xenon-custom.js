...
//Checkboxes ready to Laravel
function convertirCheckboxs(element) {
    element.find("input:checkbox").each(function() {
        var name=$(this).attr('name');
        $("input[type='hidden'][name='"+name+"']").remove();
        if($(this).prop('checked'))
            $('#fichaFormativa').append('<input type="hidden" name="'+name+'" value="1">');
        else $('#fichaFormativa').append('<input type="hidden" name="'+name+'" value="0">');
    });
}
