  ...
  if (control=="")
    ...
    if (a.length==9)
    {
        ...
        if (temp.substr(0,1)=="X" || temp.substr(0,1)=="Y" || temp.substr(0,1)=="Z")
        {
            ...
            var temp1=cambioPrimer[temp.substr(0,1)]+temp.substr(1,7);
...
$(function() {
    ...
    jQuery.extend(jQuery.validator.messages, {
            ...
            number:"Formato numérico no válido.",
            moreEq0:"Sólo se aceptan números mayores o iguales a 0",
            intMore0:"Solo se aceptan números enteros mayores de 0"
    ...
    $.validator.addMethod( "moreEq0", function ( value, element ) {
        if(value >= 0) 
            return true;
        else return false;
    });
    ...
    $.validator.addMethod("cod_postal", function(value, element) {
        ...
        },"Formato código postal incorrecto");
        ...
        $.validator.addMethod( "nif_nie", function ( value, element ) {
             ...
             if ( !value.match('((^[A-Z]{1}[0-9]{7}[A-Z0-9]{1}$|^[T]{1}[A-Z0-9]{8}$)|^[0-9]{8}[A-Z]{1}$)') ) {
                 ...
                 return validaNie(value);
                 
             
            }, "El formato del NIF o CIF parece incorrecto" );
